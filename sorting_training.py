...
sorted_letters=sorted(list,reverse=True)
...
medals = {'Japan':41, 'Russia':56, 'South Korea':21, 'United States':121, 'Germany':42, 'China':70}
medal_sorted=sorted(medals,key=lambda k:medals[k],reverse=True)

top_three=medal_sorted[:3]
...
most_needed=sorted(groceries,key=lambda k:groceries[k],reverse=Tru
"""
